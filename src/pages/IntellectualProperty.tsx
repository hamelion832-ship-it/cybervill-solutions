        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              Программные продукты, в разработке которых участвовал КИБЕРВИЛЛ, включены в Единый реестр российских программ для электронных вычислительных машин 
            ...
            <p className="text-xs text-muted-foreground italic">
              * Конкретные номера реестровых записей могут быть предоставлены по запросу
            </p>
          </div>
        </div>
      </div>
